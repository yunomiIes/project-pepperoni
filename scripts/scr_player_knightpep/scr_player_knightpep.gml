function scr_player_knightpep() //scr_player_knightpep
{
    ...
    if (grounded && (vsp > 0))
        jumpstop = 0
    if ((input_buffer_jump < 8) && (vsp > 0) && grounded && ((sprite_index == spr_knightpepidle) || (sprite_index == spr_knightpepdowntrust) || (sprite_index == spr_knightpepland) || (sprite_index == spr_knightpepwalk)))
    {
        image_index = 0
