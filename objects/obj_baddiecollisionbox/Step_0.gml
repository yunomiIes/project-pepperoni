        ...
        if ((baddieID.state != (4 << 0)) && (!baddieID.invincible) && (baddieID.state != (17 << 0)))
        {
            with (_obj_player)
            {
                ...
                if (instance_exists(other.baddieID) && (other.baddieID.invtime == 0) && (((other.baddieID.object_index != obj_bigcheese) && (other.baddieID.object_index != obj_pepbat)) || (state != (5 << 0))) && (((state == (42 << 0)) && (global.attackstyle == 1)) || (instakillmove == 1)) && (other.baddieID.state != (4 << 0)) && (!other.baddieID.invincible) && other.baddieID.instantkillable)
                    Instakill()
                else if ((state == (42 << 0)) && (global.attackstyle == 0) && (character != "S"))
                {
                    image_index = 0
                    if (!key_up)
                    {
                ...
                if (place_meeting(x, (y + 1), -2) && (state == (58 << 0)) && (vsp > 0) && (other.baddieID.vsp >= 0) && (sprite_index != spr_playerN_pogobounce) && (!other.baddieID.invincible))
                {
                ...
                if (instance_exists(other.baddieID) && (other.baddieID.object_index != obj_bigcheese) && ((state == (5 << 0)) || (state == (104 << 0)) || (sprite_index == spr_playerN_wallbounce)) && (other.baddieID.state != (80 << 0)) && (other.baddieID.state != (137 << 0)) && (!pepp_grab) && (other.baddieID.thrown == 0) && (other.baddieID.stuntouchbuffer <= 0) && (other.baddieID.state != (4 << 0)) && (other.baddieID.state != (41 << 0)) && (other.baddieID.state != (61 << 0)) && (!other.baddieID.invincible))
                {
                    var lag = 0
                ...
                if ((character != "M") && instance_exists(other.baddieID) && (state == (55 << 0)) && (!other.baddieID.invincible))
                {
                    ...
                    if ((other.baddieID.thrown == 0) && ((character == "P") || (character == "N") || (character == "PZ") || (character == "B")))
                    {
                        movespeed = 0
                        image_index = 0
                        sprite_index = spr_haulingstart
