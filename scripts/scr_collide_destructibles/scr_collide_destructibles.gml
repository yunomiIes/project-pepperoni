function scr_collide_destructibles() //gml_Script_scr_collide_destructibles
{
    with (obj_player)
    {
        if (((state == (92 << 0)) && (sprite_index == spr_playerN_noisebombspinjump)) || (ghostdash && (sprite_index != spr_ghostidle)) || (state == (165 << 0)) || (state == (31 << 0)) || (state == (187 << 0)) || (state == (198 << 0)) || ((state == (58 << 0)) && (pogochargeactive == 1)))
        {
        ...
        if ((state == (211 << 0)) || (state == (301 << 0)) || (state == (34 << 0)) || (ratmount_movespeed >= 12) || (state == (259 << 0)) || (state == (201 << 0)) || (state == (80 << 0)) || (state == (42 << 0)) || (state == (193 << 0)) || (state == (43 << 0)) || (state == (21 << 0)) || (state == (53 << 0)) || (state == (184 << 0)) || (state == (70 << 0)) || (state == (124 << 0)) || (state == (94 << 0)) || (state == (20 << 0)) || (sprite_index == spr_barrelroll) || (sprite_index == spr_player_barrelslipnslide) || (state == (41 << 0)) || (state == (121 << 0)) || (state == (47 << 0)) || (state == (306 << 0)) || ((state == (35 << 0)) && boxxeddash) || ((state == (33 << 0)) && boxxeddash) || (state == (65 << 0)) || (state == (38 << 0)) || (state == (48 << 0)) || (state == (5 << 0)) || (state == (19 << 0)) || (state == (153 << 0)))
        {
        ...
        if (((state == (47 << 0)) || (sprite_index == spr_lonegustavo_groundpoundstart) || (state == (198 << 0)) || (sprite_index == spr_lonegustavo_groundpound) || (state == (254 << 0)) || (state == (10 << 0)) || (state == (165 << 0)) || (state == (76 << 0)) || (state == (19 << 0)) || (state == (306 << 0)) || (sprite_index == spr_playerN_noisecrusherfall) || ((state == (54 << 0)) && (bombup_dir == 1))) && (vsp > 0))
        {
            var vy = 1
            if ((state == (198 << 0)) || (sprite_index == spr_lonegustavo_groundpoundstart) || (sprite_index == spr_lonegustavo_groundpound) || (state == (306 << 0)) || (sprite_index == spr_playerN_noisecrusherfall))
                vy = vsp
        ...
        ds_list_clear(global.instancelist)
        if ((vsp <= 0.5) && ((state == (92 << 0)) || (state == (300 << 0)) || (state == (192 << 0)) || (state == (301 << 0)) || (state == (104 << 0)) || (state == (306 << 0)) || (state == (265 << 0)) || (state == (58 << 0)) || ((state == (54 << 0)) && (bombup_dir == -1)) || (sprite_index == spr_playerN_noisecrusherfall) || (state == (80 << 0)) || (state == (37 << 0)) || (state == (9 << 0)) || (state == (97 << 0)) || (state == (302 << 0)) || (state == (22 << 0)) || (state == (121 << 0)) || ((state == (80 << 0)) && ((sprite_index == spr_breakdanceuppercut) || (sprite_index == spr_breakdanceuppercutend)))))
        {
            vy = -1
            if (((state == (80 << 0)) && ((sprite_index == spr_breakdanceuppercut) || (sprite_index == spr_breakdanceuppercutend))) || (state == (306 << 0)) || (sprite_index == spr_playerN_noisecrusherfall))
                vy = vsp
            if place_meeting(x, (y + vy), obj_destructibles)
            {
                with (instance_place(x, (y + vy), obj_destructibles))
                {
                    ...
                    with (other)
                    {
                        if ((state != (302 << 0)) && (state != (301 << 0)) && (state != (97 << 0)) && (state != (80 << 0)) && (state != (37 << 0)) && (state != (306 << 0)) && (sprite_index == spr_playerN_noisecrusherfall))
                            vsp = 0
                        if ((state == (97 << 0)))
                            vsp = -11
                    }
        ...
        if ((state == (108 << 0)) || (state == (76 << 0)) || (state == (111 << 0)) || (state == (165 << 0)) || (sprite_index == spr_playerN_noisecrusherfall) || ((state == (198 << 0)) && (vsp > 0)))
        {
            vy = 1
            if ((state == (198 << 0)))
                vy = (vsp + 4)
            if ((sprite_index == spr_playerN_noisecrusherfall))
                vy = vsp
            if (place_meeting(x, (y + vy), obj_metalblock) && ((freefallsmash >= 10) || (state == (165 << 0)) || (state == (198 << 0)) || (sprite_index == spr_playerN_noisecrusherfall)))
            {
