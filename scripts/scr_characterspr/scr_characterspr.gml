function scr_characterspr() //scr_characterspr
{
    if ((character == "P") && ispeppino)
    {
        ...
        spr_knightpepupslope = spr_knightpep_upslopee
        ...
        spr_mortjumpstart = spr_player_mortjumpstart
        ...
        spr_pmrpinch = spr_player_mrpinch
    ...
    if ((character == "S"))
    {
        ...
        spr_machfreefall = spr_playerS_freefall
        ...
        spr_tumblestart = spr_snick_tumblestart
        ...
        spr_rollgetup = spr_playerS_crazyrun
        spr_pmortidle = spr_player_mortidle
        spr_pmortwalk = spr_player_mortwalk
        spr_pmortland = spr_player_mortland
        spr_mortjump = spr_player_mortjump
    ...
    if ((character == "N") || (character == "NTV") || ((character == "P") && (!ispeppino)))
    {
        ...
        spr_pmortidle = spr_playerN_mortidle
        spr_pmortwalk = spr_playerN_mortwalk
        spr_pmortland = spr_playerN_mortland
        spr_mortjump = spr_playerN_mortjump
        spr_mortjumpstart = spr_playerN_mortjumpstart
        spr_mortdoublejump = spr_playerN_mortdoublejump
        ...
        spr_pmrpinch = spr_playerN_mrpinch
    ...
    if ((character == "M"))
    {
        ...
        spr_machclimbwall = spr_player_climbwall
        spr_dive = spr_player_dive
        spr_machroll = spr_pepperman_rolling
        spr_hitwall = spr_player_mach3hitwall
        spr_superjumpland = spr_player_superjumpland
        spr_walljumpstart = spr_player_walljumpstart
        spr_superjumpprep = spr_player_superjumpprep
    ...
    if ((character == "PI"))
    {
        ...
        spr_crouchslip = spr_pizzano_crouchslide2
        spr_pistolshot = spr_player_pistolshot
        spr_pistolwalk = spr_player_pistolwalk
        spr_mach1 = spr_pizzano_mach1
        spr_mach = spr_pizzano_mach2
        spr_secondjump1 = spr_pizzano_mach1jump
        spr_secondjump2 = spr_pizzano_mach1fall
        spr_machslidestart = spr_player_machslidestart
        spr_machslide = spr_player_machslide
        spr_machslideend = spr_player_machslideend
        ...
        spr_climbwall = spr_player_climbwall
        spr_clingwall = spr_player_clingwall
        spr_grab = spr_pizzano_kungfu1
        spr_mach2jump = spr_pizzano_machtwirl
        spr_Timesup = spr_player_timesup
        spr_deathstart = spr_player_deathstart
        spr_deathend = spr_player_deathend
        spr_machpunch1 = spr_player_machpunch1
        ...
        spr_piledriverland = spr_player_piledriverland
        spr_charge = spr_player_charge
        spr_mach3jump = spr_pizzano_machtwirl
        spr_mach4 = spr_pizzano_mach3shoulder
        spr_machclimbwall = spr_player_climbwall
        spr_dive = spr_player_dive
        spr_machroll = spr_pizzano_crouchslide
        spr_hitwall = spr_pizzano_mach3hitwall
        spr_superjumpland = spr_player_superjumpland
        spr_walljumpstart = spr_player_walljumpstart
        spr_superjumpprep = spr_player_Sjumpprep
        ...
        spr_machfreefall = spr_pizzano_mach1fall
        spr_mach3hit = spr_pizzano_mach3shoulder
        spr_knightpepwalk = spr_knightpep_walk
        spr_knightpepjump = spr_knightpep_jump
        spr_knightpepfall = spr_knightpep_fall
        spr_knightpepidle = spr_knightpep_idle
    ...
    if ((character == "PZ"))
    {
        ...
        spr_machslide = spr_pizzelle_machslideend
        spr_machslideend = spr_pizzelle_machslideend
        spr_machslideboost = spr_pizzelle_machslideboost
        spr_land2 = spr_pizzelle_land2
        spr_punch = spr_player_punch
        spr_backkick = spr_player_backkick
        spr_shoulder = spr_player_shoulder
        ...
        spr_crouchslide = spr_pizzelle_crouchslide
        spr_climbwall = spr_pizzelle_climbwall
        spr_clingwall = spr_player_clingwall
        spr_grab = spr_player_grab
        spr_mach2jump = spr_pizzelle_secondjump1
        spr_Timesup = spr_pizzelle_timeup
        spr_deathstart = spr_player_deathstart
        spr_deathend = spr_pizzelle_deathend
        spr_machpunch1 = spr_player_machpunch1
        spr_machpunch2 = spr_player_machpunch2
        spr_hurtjump = spr_pizzelle_hurt
        spr_entergate = spr_pizzelle_entergate
        spr_gottreasure = spr_player_gottreasure
        spr_bossintro = spr_player_bossintro
        spr_hurtidle = spr_pizzelle_timesupidle
        spr_hurtwalk = spr_pizzelle_walk
        spr_suplexmash1 = spr_player_suplexmash1
        spr_suplexmash2 = spr_player_suplexmash2
        spr_suplexmash3 = spr_player_suplexmash3
        spr_suplexmash4 = spr_player_suplexmash4
        ...
        spr_idle3 = spr_pizzelle_idleanim3
        spr_idle4 = spr_pizzelle_idleanim4
        spr_idle5 = spr_pizzelle_idleanim5_new
        spr_idle6 = spr_player_handgesture4
        spr_piledriver = spr_pizzelle_piledriver
        spr_piledriverland = spr_pizzelle_piledriverland
        spr_charge = spr_player_charge
        spr_mach3jump = spr_pizzelle_mach3jump
        spr_mach4 = spr_pizzelle_mach4
        spr_machclimbwall = spr_pizzelle_climbwall
        spr_dive = spr_pizzelle_dive
        spr_machroll = spr_pizzelle_machroll
        spr_hitwall = spr_pizzelle_mach3hitwall
        spr_superjumpland = spr_pizzelle_ceilingcrash
        spr_walljumpstart = spr_player_walljumpstart
        spr_superjumpprep = spr_pizzelle_superjumpprep
        spr_superjump = spr_pizzelle_superjump
        spr_Sjumpcancel = spr_pizzelle_superjump_cancel
        spr_Sjumpcancelland = spr_player_Sjumpcancelland
        spr_Sjumpcancelstart = spr_pizzelle_superjump_cancelprep
        spr_Sjumpcancelslide = spr_player_Sjumpcancelslide
        spr_superjumppreplight = spr_pizzelle_superjumppreplight
        spr_superjumpright = spr_pizzelle_superjumpright
        spr_superjumpleft = spr_pizzelle_superjumpleft
        spr_machfreefall = spr_pizzelle_machfreefall
        spr_mach3hit = spr_pizzelle_mach3hit
        spr_knightpepwalk = spr_knightpep_walk
        spr_knightpepjump = spr_knightpep_jump
        spr_knightpepfall = spr_knightpep_fall
        spr_knightpepidle = spr_knightpep_idle
        ...
        spr_knightpepstart = spr_knightpep_start
        spr_knightpepcharge = spr_knightpep_charge
        spr_bodyslamfall = spr_pizzelle_bodyslamfall
        ...
        spr_slipnslide = spr_pizzelle_slipnslide
        spr_mach3boost = spr_pizzelle_machslideboost3
        spr_facehurtup = spr_pizzelle_facehurtup
        spr_facehurt = spr_pizzelle_facehurt
        spr_walljumpend = spr_player_walljumpend
        spr_suplexdash = spr_pizzelle_suplexdash
        spr_suplexdashjumpstart = spr_player_suplexdash
        spr_suplexdashjump = spr_player_suplexgrabjump
        spr_shotgunsuplexdash = spr_shotgun_suplexdash
        ...
        spr_uppercutfinishingblow = spr_player_uppercutfinishingblow
        spr_finishingblow1 = spr_pizzelle_finishingblow1
        spr_finishingblow2 = spr_pizzelle_finishingblow2
        spr_finishingblow3 = spr_pizzelle_finishingblow3
        spr_finishingblow4 = spr_pizzelle_finishingblow4
        spr_finishingblow5 = spr_pizzelle_finishingblow5
        spr_winding = spr_pizzelle_winding_new
        spr_3hpwalk = spr_pizzelle_3hpwalk_new
        spr_3hpidle = spr_pizzelle_3hpidle_new
        ...
        spr_fightball = spr_player_fightball
        spr_squished = spr_player_squished
        spr_supertaunt1 = spr_pizzelle_supertaunt1
        spr_supertaunt2 = spr_pizzelle_supertaunt2
        spr_supertaunt3 = spr_pizzelle_supertaunt3
        spr_supertaunt4 = spr_pizzelle_supertaunt1
        spr_taunt = spr_pizzelle_taunt
        spr_rideweenie = spr_pizzelle_cookiemount_idle
        spr_breakdancesuper = spr_player_breakdancesuper
        ...
        spr_mortdoublejump = spr_player_mortjump
        spr_barrelroll = spr_player_barrelroll
        spr_scaredjump1 = spr_pizzelle_drown
        spr_scaredjump2 = spr_pizzelle_drown_jump
        spr_currentplayer = spr_pizzelle_outofcontrolfall
        spr_golfidle = spr_player_golfidle
        spr_golfswing = spr_player_golfswing
        spr_cheeseballplayer = spr_player_cheeseball
        spr_boxxedpepintro = spr_boxxedpep_intro
        ...
        spr_cheesepepstickceiling = spr_cheesepep_stickceilling
        spr_cheesepepstickfloor = spr_cheesepep_stick
        spr_rocketstart = spr_pizzelle_bottlerocketstart
        spr_rocket = spr_pizzelle_bottlerocket
        spr_rockethitwall = spr_player_rockethitwall
        spr_slipbanan1 = spr_pizzelle_slipnslidestart
        spr_slipbanan2 = spr_pizzelle_slipnslide
        spr_rageidle = spr_pizzelle_rageidle
        ...
        spr_grind = spr_pizzelle_grindrail
        spr_suplexland = spr_player_backflip
        spr_superspringplayer = spr_pizzelle_superspring
        spr_suplexcancel = spr_pizzelle_suplexdashCancel
        spr_mortthrow = spr_player_mortthrow
        spr_breakdanceuppercut = spr_pizzelle_uppercutbegin
        spr_breakdanceuppercutend = spr_pizzelle_uppercutend
        spr_longjump = spr_pizzelle_longjump
        spr_longjumpend = spr_pizzelle_longjumpend
        spr_poundcancel1 = spr_pizzelle_groundpound
        spr_poundcancel2 = spr_pizzelle_groundpoundland
        spr_breakdance = spr_pizzelle_breakdance
        spr_wallsplat = spr_pizzelle_splat
        spr_palette = spr_peppalette
        paletteselect = 1
    }
    if ((character == "B"))
    {
        spr_idle = spr_playerB_idle
        spr_move = spr_playerB_move
        spr_crawl = spr_playerB_crawl
        spr_hurt = spr_playerB_hurt
        spr_jump = spr_playerB_jump
        spr_jump2 = spr_player_jump2
        spr_fall = spr_playerB_fall
        spr_fall2 = spr_player_fall2
        spr_crouch = spr_playerB_crouch
        spr_crouchjump = spr_playerB_crouchjump
        spr_crouchfall = spr_playerB_crouchfall
        spr_couchstart = spr_playerB_crouchstart
        spr_bump = spr_playerB_bump
        spr_land = spr_playerB_land
        spr_land2 = spr_playerB_land2
        spr_lookdoor = spr_playerB_lookdoor
        spr_walkfront = spr_playerB_walkfront
        spr_victory = spr_playerB_victory
        spr_Ladder = spr_playerB_ladder
        spr_laddermove = spr_playerB_laddermove
        spr_ladderdown = spr_playerB_ladderdown
        spr_keyget = spr_playerB_keyget
        spr_crouchslip = spr_playerB_crouchslip
        spr_pistolshot = spr_player_pistolshot
        spr_pistolwalk = spr_player_pistolwalk
        spr_mach1 = spr_playerB_mach1
        spr_mach = spr_playerB_mach
        spr_secondjump1 = spr_playerB_secondjump1
        spr_secondjump2 = spr_playerB_secondjump2
        spr_machslidestart = spr_playerB_machslidestart
        spr_machslide = spr_playerB_machslide
        spr_machslideend = spr_playerB_machslideend
        spr_machslideboost = spr_playerB_machslideboost
        spr_land2 = spr_playerB_land2
        spr_punch = spr_playerN_punch
        spr_backkick = spr_playerN_backkick
        spr_shoulder = spr_playerN_shoulder
        spr_uppunch = spr_playerN_uppunch
        spr_stomp = spr_playerB_stomp
        spr_stompprep = spr_playerB_stompprep
        spr_crouchslide = spr_player_crouchslide
        spr_crouch = spr_playerB_crouch
        spr_climbwall = spr_playerB_climbwall
        spr_clingwall = spr_player_clingwall
        spr_grab = spr_playerN_grab
        spr_mach2jump = spr_playerB_mach2jump
        spr_Timesup = spr_playerB_timesup
        spr_deathstart = spr_playerN_deathstart
        spr_deathend = spr_playerB_deathend
        spr_machpunch1 = spr_playerB_machpunch1
        spr_machpunch2 = spr_playerB_machpunch2
        spr_hurtjump = spr_playerB_hurtjump
        spr_entergate = spr_playerB_entergate
        spr_gottreasure = spr_playerB_gottreasure
        spr_bossintro = spr_playerN_bossintro
        spr_hurtidle = spr_playerB_hurtidle
        spr_hurtwalk = spr_playerB_hurtwalk
        spr_suplexmash1 = spr_playerN_suplexmash1
        spr_suplexmash2 = spr_playerN_suplexmash2
        spr_suplexmash3 = spr_playerN_suplexmash3
        spr_suplexmash4 = spr_playerN_suplexmash4
        ...
        spr_airdash2 = spr_playerN_airdash2
        spr_keyget = spr_playerB_keyget
        spr_idle1 = spr_playerB_idlemask
        spr_idle2 = spr_playerB_idledance
        spr_idle3 = spr_playerB_idleballoon
        spr_idle4 = spr_playerB_idlegun
        spr_idle5 = spr_playerB_idlesmoke
        spr_idle6 = spr_playerB_idleface
        spr_piledriver = spr_playerB_piledriver
        spr_piledriverland = spr_playerB_piledriverland
        spr_charge = spr_playerN_charge
        spr_mach3jump = spr_playerB_mach3jump
        spr_mach4 = spr_playerB_mach3
        spr_machclimbwall = spr_playerB_climbwall
        spr_dive = spr_playerB_dive
        spr_machroll = spr_playerB_machroll
        spr_hitwall = spr_playerB_mach3hitwall
        spr_superjumpland = spr_playerB_Sjumpland
        spr_walljumpstart = spr_playerB_walljumpstart
        spr_superjumpprep = spr_playerB_Sjumpstart
        spr_superjump = spr_playerB_Sjump
        spr_Sjumpcancel = spr_player_Sjumpcancel
        spr_Sjumpcancelland = spr_player_Sjumpcancelland
        spr_Sjumpcancelstart = spr_player_Sjumpcancelstart
        spr_Sjumpcancelslide = spr_player_Sjumpcancelslide
        spr_superjumppreplight = spr_playerB_Sjumpprep
        spr_superjumpright = spr_playerB_Sjumpmoveright
        spr_superjumpleft = spr_playerB_Sjumpmoveleft
        spr_machfreefall = spr_playerB_machfreefall1
        spr_mach3hit = spr_playerB_machpunch1
        spr_knightpepwalk = spr_playerB_knightmove
        spr_knightpepjump = spr_playerB_knightjump
        spr_knightpepfall = spr_playerB_knightfall
        spr_knightpepidle = spr_playerB_knightidle
        spr_knightpepjumpstart = spr_playerB_knightjumpstart
        spr_knightpepthunder = spr_knightpep_thunder
        spr_knightpepland = spr_playerB_knightland
        spr_knightpepdownslope = spr_playerB_knightdownslope
        spr_knightpepstart = spr_playerB_knightstart
        spr_knightpepcharge = spr_playerB_knightslide
        spr_bodyslamfall = spr_playerB_bodyslam
        spr_bodyslamstart = spr_playerB_bodyslamstart
        spr_bodyslamland = spr_playerB_bodyslamland
        spr_crazyrun = spr_playerB_crazyrun
        spr_bombpeprun = spr_bombpep_run
        spr_bombpepintro = spr_bombpep_intro
        spr_bombpeprunabouttoexplode = spr_bombpep_runabouttoexplode
        spr_bombpepend = spr_bombpep_end
        ...
        spr_fireassground = spr_playerN_fireassground
        spr_fireassend = spr_playerN_fireassend
        spr_tumblestart = spr_playerB_tumblestart
        spr_tumbleend = spr_playerB_tumbleend
        spr_tumble = spr_playerB_tumble
        spr_stunned = spr_playerN_stunned
        spr_clown = spr_playerN_clown
        spr_clownbump = spr_playerN_clownbump
        spr_clowncrouch = spr_playerN_clowncrouch
        ...
        spr_clownjump = spr_playerN_clownjump
        spr_clownwallclimb = spr_playerN_clownwallclimb
        spr_downpizzabox = spr_playerB_downpizzabox
        spr_uppizzabox = spr_playerB_uppizzabox
        spr_slipnslide = spr_playerB_slipbanan1
        spr_mach3boost = spr_playerB_mach3boost
        spr_facehurtup = spr_playerN_facehurtup
        spr_facehurt = spr_playerB_facehurt
        spr_walljumpend = spr_playerB_walljumpend
        spr_suplexdash = spr_playerB_suplexgrab
        spr_suplexdashjumpstart = spr_playerB_suplexgrabjumpstart
        spr_suplexdashjump = spr_playerB_suplexgrabjump
        spr_shotgunsuplexdash = spr_playerB_minigundash
        spr_rollgetup = spr_playerB_rollgetup
        spr_swingding = spr_playerB_swingding
        spr_swingdingend = spr_playerB_swingdingend
        spr_haulingjump = spr_playerB_haulingjump
        spr_haulingidle = spr_playerB_haulingidle
        spr_haulingwalk = spr_playerB_haulingmove
        spr_haulingstart = spr_playerB_haulingstart
        spr_haulingfall = spr_playerB_haulingfall
        spr_haulingland = spr_playerB_haulingland
        spr_uppercutfinishingblow = spr_player_uppercutfinishingblow
        spr_finishingblow1 = spr_playerB_finishingblow1
        spr_finishingblow2 = spr_playerB_finishingblow2
        spr_finishingblow3 = spr_playerB_finishingblow3
        spr_finishingblow4 = spr_playerB_finishingblow4
        spr_finishingblow5 = spr_playerB_finishingblow5
        spr_winding = spr_playerB_winding
        spr_3hpwalk = spr_playerB_angrymove
        spr_3hpidle = spr_playerB_angryidle
        spr_panic = spr_playerB_panicidle
        spr_facestomp = spr_player_facestomp
        spr_freefall = spr_playerB_machfreefall2
        spr_shotgunland = spr_playerB_minigunland
        spr_shotgunshoot = spr_playerB_minigunshoot
        spr_shotgunidle = spr_playerB_minigunidle
        spr_shotgunwalk = spr_playerB_minigunmove
        spr_shotgunfall = spr_playerB_minigunfall
        spr_shotgunjump = spr_playerB_minigunjump
        spr_shotgunjump1 = spr_player_shotgunjump1
        spr_shotgunjump2 = spr_player_shotgunjump2
        spr_shotgunjump3 = spr_player_shotgunjump3
        spr_shotgunpullout = spr_playerB_minigunstart
        spr_shotgunduck = spr_playerB_minigunduck
        spr_shotguncrawl = spr_playerB_miniguncrawl
        spr_shotgungoduck = spr_playerB_minigungoduck
        spr_fightball = spr_player_fightball
        spr_squished = spr_player_squished
        spr_supertaunt1 = spr_playerB_supertaunt1
        spr_supertaunt2 = spr_playerB_supertaunt1
        spr_supertaunt3 = spr_playerB_supertaunt1
        spr_supertaunt4 = spr_playerB_supertaunt1
        spr_taunt = spr_playerB_taunt
        spr_rideweenie = spr_player_weeniemount
        spr_breakdancesuper = spr_player_breakdancesuper
        spr_dashpadmach = spr_playerB_dashpad
        spr_firemouthintro = spr_playerN_firemouthintro
        spr_firemouthend = spr_playerN_firemouthend
        spr_firemouth = spr_playerN_firemouth
        spr_ghostdash = spr_playerN_ghostdash
        ...
        spr_scaredjump2 = spr_player_scaredjump2
        spr_currentplayer = spr_player_current
        spr_golfidle = spr_playerB_golfidle
        spr_golfswing = spr_playerN_golfswing
        spr_cheeseballplayer = spr_player_cheeseball
        spr_boxxedpepintro = spr_boxxedpep_intro
        spr_boxxedpepidle = spr_boxxedpep_idle
        ...
        spr_rocketstart = spr_playerN_rocketstart
        spr_rocket = spr_playerN_rocket
        spr_rockethitwall = spr_playerB_rockethitwall
        spr_slipbanan1 = spr_playerB_slipbanan1
        spr_slipbanan2 = spr_playerB_slipbanan2
        spr_rageidle = spr_playerB_rageidle
        spr_ragemove = spr_playerB_ragemove
        spr_parry1 = spr_playerB_parry1
        spr_parry2 = spr_playerB_parry2
        spr_parry3 = spr_playerB_parry3
        spr_dead = spr_playerB_deathend
        spr_suplexbump = spr_playerB_suplexbump
        spr_grind = spr_playerB_grind
        spr_suplexland = spr_player_backflip
        spr_superspringplayer = spr_playerB_superspring
        spr_suplexcancel = spr_playerB_suplexcancel
        spr_mortthrow = spr_player_mortthrow
        spr_breakdanceuppercut = spr_playerB_breakdanceuppercut
        spr_breakdanceuppercutend = spr_playerB_breakdanceuppercutend
        spr_longjump = spr_playerB_longjump
        spr_longjumpend = spr_playerB_longjumpend
        spr_poundcancel1 = spr_playerB_poundcancel1
        spr_poundcancel2 = spr_playerB_poundcancel2
        spr_breakdance = spr_playerB_breakdance
        spr_palette = spr_peppalette
        paletteselect = 1
    }
    return;
