...
switch state
{
    ...
    case (0 << 0):
    case (98 << 0):
        scr_bosscontroller_draw_health(3134, player_rowmax, player_columnmax, player_hp, player_maxhp, player_hp_x, player_hp_y, player_xpad, player_ypad, player_index, image_alpha, 546, obj_player1.paletteselect, global.palettetexture)
