if ((state == (4 << 0)) && (object_index != obj_pepperman) && (object_index != obj_pizzafaceboss) && (object_index != obj_vigilanteboss) && (object_index != obj_pizzafaceboss_p3) && (object_index != obj_noiseboss) && (object_index != obj_pf_fakepep))
    ...
    scr_enemy_secret()
if ((room == boss_pizzaface) && (state != (270 << 0)))
    use_collision = true
scr_squash()
...
if ((state != (270 << 0)) && (object_index != obj_pepperman) && (object_index != obj_noiseboss) && (object_index != obj_pizzafaceboss) && (object_index != obj_pf_fakepep) && (object_index != obj_fakepepboss) && (object_index != obj_vigilanteboss) && (object_index != obj_pizzafaceboss_p2) && (object_index != obj_pizzafaceboss_p3) && (object_index != obj_noisey) && (object_index != obj_gustavograbbable))
{
...
if (self.fmod_event_instance_is_playing(chargesnd) && (state != (128 << 0)))
    self.fmod_event_instance_stop(chargesnd)
