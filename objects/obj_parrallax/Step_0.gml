...
for (var i = 0; i < array_length(lay_arr); i++)
{
    ...
    {
        case "Assets_BG3":
            layer_x(lay, (_cam_x * 0.02))
            layer_y(lay, (_cam_y * 0.02))
            break
        case "Assets_BG2":
        ...
        case "Backgrounds_still2":
            ...
            var per_x = (_cam_x / (room_width - obj_camera.original_cam_width))
            var per_y = (_cam_y / (room_height - obj_camera.original_cam_height))
