...
switch state
{
    ...
    case (265 << 0):
        ...
        break
    case (270 << 0):
        scr_player_breakdanceC()
        break
    case (290 << 0):
        scr_player_backtohub()
        break
    case (304 << 0):
        scr_player_wallbounce()
        break
    case (305 << 0):
        scr_playerN_machcancelstart2()
        break
    case (306 << 0):
        scr_playerN_machcancel2()
        break
    case (308 << 0):
        scr_player_crusherpound()
        break
    case (309 << 0):
        scr_playerN_freezerintro()
        break
}
...
if ((global.noisejetpack && (character != "NTV")) || ((character == "NTV") && pizzapepperN && global.noisejetpack))
{
    if ((jetpackeffect > 0))
        jetpackeffect--
    else
...
if ((noise_wallbounce_buffer > 0))
    noise_wallbounce_buffer--
if ((cow_buffer > 0))
    cow_buffer--
if ((state == (43 << 0)))
    lunge_buffer = 14
if ((blur_effect > 0))
    blur_effect--
else if ((breakdance_speed >= 0.6) || (mach4mode == 1) || (boxxeddash == 1) || (state == (16 << 0)) || ((state == (5 << 0)) && (sprite_index != spr_player_faceplant) && (sprite_index != spr_pizzelle_machtumble)) || (state == (198 << 0)) || (state == (193 << 0)) || (state == (42 << 0)) || (state == (116 << 0)) || ((state == (79 << 0)) && (sprite_index == spr_swingding) && (swingdingdash <= 0)) || (state == (108 << 0)) || (state == (43 << 0)))
{
...
if ((wallclingcooldown < 10))
    wallclingcooldown++
if ((!instance_exists(superchargedeffectid)) && supercharged && visible)
{
...
if ((state == (89 << 0)) && (y > (room_height * 2)) && (!global.checkpoints))
{
    targetDoor = "A"
    scr_playerreset()
    if ((global.coop == 1))
...
if ((baddiegrabbedID == 550) && ((state == (79 << 0)) || (state == (76 << 0)) || (state == (20 << 0))))
    state = (0 << 0)
...
if ((global.stylethreshold >= 2) && (!instance_exists(angryeffectid)) && (state == (0 << 0)) && (character != "V") && (character != "M"))
{
...
if ((object_index == obj_player1))
{
    ...
    if (!(((state == (112 << 0)) || (state == (150 << 0)) || (state == (119 << 0)) || (state == (46 << 0)) || (state == (98 << 0)) || (state == (46 << 0)) || (state == (146 << 0)) || (state == (208 << 0)) || (sprite_index == spr_bombpep_intro) || (sprite_index == spr_bombpep_run) || (sprite_index == spr_playerN_rocketstart) || (state == (95 << 0)) || (state == (90 << 0)) || ((state == (47 << 0)) && ((sprite_index == spr_knightpepstart) || (sprite_index == spr_knightpepthunder))) || instance_exists(obj_fadeout) || place_meeting(x, y, obj_secretportal) || place_meeting(x, y, obj_secretportalstart))))
    {
        if ((room != forest_G1b))
        {
...
if ((inv_frames == 0) && (hurted == 0) && (state != (16 << 0)))
    image_alpha = 1
if ((state == (80 << 0)) || ((state == (92 << 0)) && (sprite_index == spr_playerN_noisebombspinjump)) || (state == (20 << 0)) || (state == (77 << 0)) || (state == (47 << 0)) || (state == (24 << 0)) || (state == (38 << 0)) || (state == (48 << 0)) || (state == (51 << 0)) || (state == (62 << 0)) || (state == (73 << 0)) || (state == (62 << 0)) || (state == (121 << 0)) || (state == (270 << 0)) || (state == (108 << 0)) || (state == (97 << 0)))
    attacking = 1
else
    attacking = 0
if ((state == (74 << 0)) || (state == (81 << 0)) || (state == (83 << 0)) || (state == (82 << 0)))
    ...
    grabbing = 0
if (((state == (198 << 0)) && (vsp >= 0)) || (sprite_index == spr_player_Sjumpcancel) || (sprite_index == spr_swingding) || (sprite_index == spr_tumble) || (state == (34 << 0)) || (state == (211 << 0)) || (state == (210 << 0)) || (state == (70 << 0)) || ((state == (71 << 0)) && ((sprite_index == spr_shotgunjump2) || (sprite_index == spr_shotgunjump3))) || (state == (97 << 0)) || (state == (184 << 0)) || (state == (185 << 0)) || (state == (41 << 0)) || (state == (80 << 0)) || (state == (124 << 0)) || (state == (31 << 0)) || (state == (121 << 0)) || ((state == (92 << 0)) && (sprite_index == spr_playerN_noisebombspinjump)) || (state == (108 << 0)) || (state == (9 << 0)) || (state == (254 << 0)) || (state == (10 << 0)) || (state == (19 << 0)) || (state == (254 << 0)) || (state == (77 << 0)) || (state == (63 << 0)) || (state == (97 << 0)) || (state == (73 << 0)) || ((sprite_index == spr_mach3boost) && finalmoveset) || (state == (20 << 0)) || (global.noisejetpack && (character != "NTV")) || (global.noisejetpack && pizzapepperN && (character == "NTV")) || ((state == (76 << 0)) && (sprite_index == spr_piledriver)) || (state == (47 << 0)) || (state == (48 << 0)) || (state == (38 << 0)) || (state == (187 << 0)) || (state == (24 << 0)) || (state == (21 << 0)) || (state == (201 << 0)) || (sprite_index == spr_slipnslide) || (state == (197 << 0)) || ((state == (5 << 0)) && (character == "PZ") && (sprite_index == spr_pizzelle_machtumble)) || (sprite_index == spr_player_faceplant) || (state == (270 << 0)) || (state == (305 << 0)) || (state == (304 << 0)) || (sprite_index == spr_playerN_divebomb) || (sprite_index == spr_playerN_divebombland) || (sprite_index == spr_playerN_divebombfall) || (state == (308 << 0)) || ((state == (5 << 0)) && (character == "PI") && (sprite_index == spr_pizzano_crouchslide) && (movespeed >= 12)) || (state == (259 << 0)) || (state == (265 << 0)) || (ratmount_movespeed == 12) || ((state == (16 << 0)) && (ghostdash != 0)) || (state == (165 << 0)) || (state == (153 << 0)) || (holycross > 0) || ((character == "NTV") && (state == (94 << 0)) && instance_exists(obj_surfback)) || (sprite_index == spr_pizzelle_mach3rollstart_new) || (sprite_index == spr_pizzelle_mach3roll_new) || (sprite_index == spr_playerN_noisecrusherstart) || (sprite_index == spr_playerN_noisecrusherfall) || (sprite_index == spr_playerN_wallbounce))
    instakillmove = 1
else
    instakillmove = 0
...
if ((state == (46 << 0)) || (sprite_index == spr_knightpepstart) || (sprite_index == spr_knightpepthunder) || (state == (90 << 0)) || (state == (61 << 0)) || (state == (112 << 0)) || (state == (7 << 0)) || (state == (98 << 0)) || (state == (95 << 0)) || (state == (89 << 0)) || (state == (186 << 0)) || (state == (152 << 0)) || (state == (146 << 0)) || place_meeting(x, y, obj_secretportal) || place_meeting(x, y, obj_secretportalstart))
    ...
    cutscene = 0
if (((place_meeting(x, y, obj_door) && (!(place_meeting(x, y, obj_doorblocked)))) || place_meeting(x, y, obj_taxi) || place_meeting(x, y, obj_dialognpc) || place_meeting(x, y, obj_dresser) || place_meeting(x, y, obj_dressertest) || place_meeting(x, y, obj_keydoor) || place_meeting(x, y, obj_filedoor) || place_meeting(x, y, obj_optiondoor) || (place_meeting(x, y, obj_exitgate) && (global.panic == 1))) && (!instance_exists(obj_uparrow)) && scr_solid(x, (y + 1)) && (state == (0 << 0)) && (obj_player1.spotlight == 1))
{
    with (instance_create(x, y, obj_uparrow))
        playerid = other.object_index
}
if ((movespeed >= 12) && (state == (121 << 0)) && (!instance_exists(speedlineseffectid)))
{
...
if ((state != (47 << 0)) && (state != (16 << 0)) && (state != (38 << 0)))
{
    if ((character == "PZ") || (character == "PI") || sloperotation)
    {
        if (!scr_slope())
...
if breakdancecancel1
{
    if (key_shoot2 && (!shotgunAnim) && (state != (80 << 0)) && (character != "S") && (character != "V"))
    {
        if ((state == (0 << 0)) || (state == (121 << 0)) || (state == (104 << 0)) || (state == (92 << 0)))
        {
            if ((movespeed <= 8))
                movespeed = 9
            if ((state != (121 << 0)) || (movespeed < 16))
                vsp = -5
            state = (270 << 0)
...
if ((state != (95 << 0)) && (room == freezer_1) && (character == "NTV") && (!global.noisejetpack) && (sprite_index != spr_playerN_freezerintro))
{
    scr_soundeffect(sfx_noise_freezerintro)
    image_speed = 0.35
