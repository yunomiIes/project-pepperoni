...
if ((obj_player.state != (89 << 0)))
{
    ...
    if ((obj_player1.character != "PZ"))
        ...
        draw_sprite_ext(spr_cakehud, pizzascore_index, hud_xx, hud_yy, 1, 1, 0, c_white, alpha)
    ...
    {
        spr_w = sprite_get_width(spr_ranks_hudfillSP)
        spr_h = sprite_get_height(spr_ranks_hudfillSP)
        spr_xo = sprite_get_xoffset(spr_ranks_hudfillSP)
        spr_yo = sprite_get_yoffset(spr_ranks_hudfillSP)
    }
    var perc = 0
    switch rank_ix
    {
    ...
    if ((obj_player1.character != "PZ"))
        ...
        draw_sprite_ext(spr_ranks_hudSP, rank_ix, rx, ry, rank_scale, rank_scale, 0, c_white, 1)
    if ((perc != 1))
    {
        if ((obj_player1.character != "PZ"))
            draw_sprite_part(spr_ranks_hudfill, rank_ix, 0, top, spr_w, (spr_h - top), (rx - spr_xo), ((ry - spr_yo) + top))
        else
            draw_sprite_part(spr_ranks_hudfillSP, rank_ix, 0, top, spr_w, (spr_h - top), (rx - spr_xo), ((ry - spr_yo) + top))
    }
    ...
    if ((obj_player1.character != "PZ"))
        ...
        draw_set_font(global.collectfontSPCandle)
    var text_y = 0
...
{
    var _cammid = (original_cam_width / 2)
    ...
    if ((global.lowfacefill >= 1))
    {
        ...
        if ((string_length(_mins) == 1))
            _mins = ("0" + _mins)
        var _secs = string((frames_in_seconds(global.lowfacefill) % 60))
