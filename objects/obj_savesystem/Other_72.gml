...
switch state
{
    ...
    case 2:
        if ((ident == loadid))
        {
            ...
            global.entrancecutscene = ini_read_real("cutscene", "jingle_entrance", 0)
            global.medievalcutscene = ini_read_real("cutscene", "jingle_medieval", 0)
            global.ruincutscene = ini_read_real("cutscene", "jingle_ruin", 0)
            global.dungeoncutscene = ini_read_real("cutscene", "jingle_dungeon", 0)
            global.desertcutscene = ini_read_real("cutscene", "desert", 0)
            global.graveyardcutscene = ini_read_real("cutscene", "jingle_graveyard", 0)
            global.farmcutscene = ini_read_real("cutscene", "farm", 0)
            global.spacecutscene = ini_read_real("cutscene", "space", 0)
            global.beachcutscene = ini_read_real("cutscene", "jingle_beach", 0)
            ...
            global.factorycutscene = ini_read_real("cutscene", "jingle_factory", 0)
            global.freezercutscene = ini_read_real("cutscene", "jingle_freezer", 0)
            global.chateaucutscene = ini_read_real("cutscene", "jingle_chateau", 0)
            ...
            global.entrancetreasure = ini_read_real("Treasure", "jingle_entrance", 0)
            global.medievaltreasure = ini_read_real("Treasure", "jingle_medieval", 0)
            global.ruintreasure = ini_read_real("Treasure", "jingle_ruin", 0)
            global.dungeontreasure = ini_read_real("Treasure", "jingle_dungeon", 0)
            global.deserttreasure = ini_read_real("Treasure", "desert", 0)
            global.graveyardtreasure = ini_read_real("Treasure", "jingle_graveyard", 0)
            global.farmtreasure = ini_read_real("Treasure", "farm", 0)
            global.spacetreasure = ini_read_real("Treasure", "space", 0)
            global.beachtreasure = ini_read_real("Treasure", "jingle_beach", 0)
            ...
            global.factorytreasure = ini_read_real("Treasure", "jingle_factory", 0)
            global.freezertreasure = ini_read_real("Treasure", "jingle_freezer", 0)
            global.chateautreasure = ini_read_real("Treasure", "jingle_chateau", 0)
