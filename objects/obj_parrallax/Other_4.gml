...
for (var i = 0; i < array_length(asset_layers); i++)
{
    ...
    if layer_exists(b)
    {
        ...
        for (var j = 0; j < array_length(q); j++)
        {
            ...
            if ((p[0] != 0))
                layer_sprite_x(_asset, ((_x - (_x * p[0])) + ((obj_camera.original_cam_width / 4) * p[0])))
            if ((p[1] != 0) && (spr != spr_industrialpipe) && (spr != bg_farmdirtwall))
                layer_sprite_y(_asset, ((_y - (_y * p[1])) + ((obj_camera.original_cam_height / 4) * p[1])))
        }
    }
}
if global.hidetiles
...
if global.opttiles
{
    if ((string_copy(room_get_name(room), 1, 8) == "entrance"))
    {
        layer_set_visible("Tiles_BG", 0)
        layer_set_visible("Foreground_1", 0)
    }
    if ((room != medieval_4) && (room != medieval_5) && (room != medieval_6) && (room != medieval_7) && (room != medieval_8) && (room != medieval_9) && (room != medieval_3b) && (room != medieval_9b) && (string_copy(room_get_name(room), 1, 8) == "medieval"))
    {
        layer_set_visible("Tiles_BG", 0)
        layer_set_visible("Tiles_3", 0)
        layer_set_visible("Tiles_1", 0)
    ...
    if ((room == medieval_5) || (room == medieval_6) || (room == medieval_7) || (room == medieval_10) || (room == medieval_9b))
    {
        layer_set_visible("Tiles_BG", 0)
        layer_set_visible("Tiles_2", 0)
    }
    ...
    if ((room == medieval_9) || (room == medieval_3b))
    {
        layer_set_visible("Tiles_3", 0)
        layer_set_visible("Tiles_BG", 0)
    }
    if ((string_copy(room_get_name(room), 1, 4) == "ruin"))
    {
        layer_set_visible("Tiles_BG", 0)
        layer_set_visible("Tiles_Foreground1", 0)
        layer_set_visible("Tiles_Foreground2", 0)
    ...
    if ((string_copy(room_get_name(room), 1, 7) == "dungeon"))
    {
        layer_set_visible("Tiles_BG", 0)
        layer_set_visible("Tiles_Foreground1", 0)
        layer_set_visible("Tiles_Foreground2", 0)
...
bg_stillxoffset = layer_get_x("Backgrounds_still")
bg_stillyoffset = layer_get_y("Backgrounds_still")
...
bg_still3xoffset = layer_get_x("Backgrounds_still3")
bg_still3yoffset = layer_get_y("Backgrounds_still3")
