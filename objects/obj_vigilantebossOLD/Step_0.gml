targetplayer = (global.coop ? instance_nearest(x, y, obj_player) : 349)
...
attacking = ((state == (1 << 0)) ? true : ((state == (103 << 0)) ? true : ((state == (128 << 0)) ? true : ((state == (80 << 0)) ? true : ((state == (164 << 0)) ? true : ((state == (166 << 0)) ? true : ((state == (108 << 0)) ? true : ((state == (82 << 0)) ? true : ((state == (42 << 0)) ? true : ((state == (160 << 0)) ? true : ((state == (158 << 0)) ? true : (state == (102 << 0)))))))))))))
