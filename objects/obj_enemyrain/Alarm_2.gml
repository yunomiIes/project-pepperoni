...
if ((instance_number(obj_baddie) < 20))
{
    ...
    with (instance_create(clamp(spawnxrandom, 200, (room_width - 200)), spawny, choose(obj_junkenemy, obj_warblock, obj_banditochicken, obj_enemybird, obj_noisegoblin, obj_pineahitbox, obj_robot)))
    {
