...
dialog = [dialog_create("Abracadabra", -4, function() //gml_Script_anon_gml_RoomCC_hub_grandpizzardtowerinterior_1_Create_196_gml_RoomCC_hub_grandpizzardtowerinterior_1_Create
{
