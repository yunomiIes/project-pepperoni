...
global.entrancetime = ini_read_string("Time", "jingle_entrance", "none")
global.medievaltime = ini_read_string("Time", "jingle_medieval", "none")
global.ruintime = ini_read_string("Time", "jingle_ruin", "none")
global.dungeontime = ini_read_string("Time", "jingle_dungeon", "none")
global.chateautime = ini_read_string("Time", "jingle_chateau", "none")
global.strongcoldtime = ini_read_string("Time", "strongcold", "none")
ini_close()
switch levelsign
{
    case "jingle_entrance":
